package co.ke.xently.template.features.users.repositories

import androidx.core.content.edit
import co.ke.xently.template.features.Dependencies
import co.ke.xently.template.features.users.BasicAuth
import co.ke.xently.template.features.users.repositories.exceptions.*
import co.ke.xently.template.libraries.data.source.User
import co.ke.xently.template.libraries.data.source.asUIInstance
import co.ke.xently.template.libraries.data.source.remote.ExceptionUtils.retryCatch
import co.ke.xently.template.libraries.data.source.remote.Http.sendRequest
import co.ke.xently.template.libraries.data.source.utils.Retry
import co.ke.xently.template.libraries.data.source.utils.SharedPreferenceKey
